...
public class ListPrice_Offer {
    ...
    public String toString() {
        ...
        sb.append(ListPrice_Offer.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ListPrice_Offer) == false) {
            return false;
        }
        ListPrice_Offer rhs = ((ListPrice_Offer) other);
