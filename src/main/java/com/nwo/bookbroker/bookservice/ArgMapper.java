...
class ArgMapper {
     ...
     */
    static String mapIsbn(List<IndustryIdentifier> identifiers, String recordId) {
     ...
     */
    static String mapTitle(String sourceTitle) {
     ...
     */
    static String mapSubtitle(String sourceSubtitle) {
     ...
     */
    static String mapPublisher(String sourcePublisher) {
     ...
     */
    static String mapPublishedDate(String sourceDate) {
     ...
     */
    static String mapDescription(String sourceDescription) {
     ...
     */
    static Integer mapPageCount(Integer sourcePageCount) {
     ...
     */
    static String mapThumbnailUrl(String sourceThumbnailUrl) {
     ...
     */
    static String mapLanguage(String sourceLanguage) {
     ...
     */
    static String mapPreviewLink(String sourcePreviewLink) {
     ...
     */
    static Double mapAverageRating(Double sourceAverageRating) {
     ...
     */
    static List<String> mapAuthors(List<String> sourceAuthors) {
     ...
     */
    static List<String> mapCategories(List<String> sourceCategories) {
